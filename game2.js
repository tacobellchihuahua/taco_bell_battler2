...
const FRAMEWORKS = {
  'Expectancy Theory': [
    { dmg: 40, text: "Motivation is multiplicative — E×P×O×Valence. If any term is zero, the product is zero. E-to-P is broken here: briefs change every rotation, nobody knows which inputs drive outcomes." },
    { dmg: 30, text: "P-to-O is invisible. Strong campaign work gets rewarded with a new assignment to something you've never touched. That's a negative valence dressed as a career benefit." },
    { dmg: 20, text: "Valence mismatch. The org offers enterprise mindset. The brand lead six months in wants to finish what they started. You're offering a reward nobody asked for." },
    { dmg: 5,  text: "Send a welcome gift basket and the motivation numbers will go up. The basket has a Live Mas mug. It is genuine.", trap: true },
  ],
  'Job Char. Model': [
    { dmg: 40, text: "Three of five JCM dimensions are severed by rotation: task identity gone, feedback reset with every new coach, autonomy collapsed before it starts. Skill variety alone doesn't carry the model." },
    { dmg: 30, text: "Feedback is the first dimension rotation destroys. Without a stable coach, autonomy feels like abandonment — not trust. The brand lead is driving blind." },
    { dmg: 20, text: "Skill variety is the one dimension rotation improves. The org knows this. But one dimension doesn't compensate for three missing." },
    { dmg: 5,  text: "Add more stretch assignments. Six product lines in three years. The JCM box score looks excellent in the deck.", trap: true },
  ],
  'Crowding Out': [
    { dmg: 40, text: "The retention bonus converted a career commitment into a transaction. The brand lead who already cared now has a signal that staying requires payment. Gneezy and Rustichini called this in 2000." },
    { dmg: 30, text: "The check-in template and tracking dashboard sent a signal: we don't trust you. The brand lead started managing the process instead of the campaign." },
    { dmg: 20, text: "Heath at Citibank: managers rank pay first, employees rank interesting work first. You keep pulling the extrinsic levers because you can see them." },
    { dmg: 5,  text: "Implement a completion bonus. A Taco Bell gift card. There is some irony in the gift card but the intent is genuine.", trap: true },
  ],
  'Folly: A→B': [
    { dmg: 40, text: "You reward rotation velocity and hope for institutional knowledge. Wells Fargo rewarded accounts opened and hoped for customer relationships. The diagnostic question: what does your incentive system actually reward?" },
    { dmg: 30, text: "The performance review rewards leads who rotate gracefully. There is no rubric item for stayed long enough to finish the thing. The system selects for the behavior you don't want." },
    { dmg: 20, text: "What does your system actually reward? Rotation compliance. Breadth. Being agreeable when your lead says move. You want continuity. You're rewarding the opposite. On a laminated poster." },
    { dmg: 5,  text: "Add campaign completion as item nine of twelve on the rubric. We'll see which box gets filled in at year-end review.", trap: true },
  ],
  'Tight / Loose': [
    { dmg: 40, text: "Operations: tight, non-negotiable. Campaign ownership: loose, subject to rotation. Those are backwards. You need to consciously choose where tightness applies — right now it drifted toward the wrong things." },
    { dmg: 30, text: "The Doritos Locos Taco worked because ownership was tight all the way to ship. They didn't rotate the inventor to the Cinnamon Twists account at the forty-yard line." },
    { dmg: 20, text: "The org knows how to be tight — franchise compliance, supply chain, food safety. That muscle exists. Nobody has asked for it on the brand side." },
    { dmg: 5,  text: "Add campaign ownership norms to a new onboarding module. Nobody finished the 2021 module but the intent is strong.", trap: true },
  ],
  'Network Shape': [
    { dmg: 40, text: "Internal density: near zero. External range: fragmented across four people who each think they're the POC. Low density and low range — that's the isolated-and-slow failure mode." },
    { dmg: 30, text: "Partners stopped investing in relationships with brand leads because the last six rotated within the year. Suppressed internal density isn't resistance. It's rational." },
    { dmg: 20, text: "The last lead had the agency contact in their phone. Under Baja Blast Guy. That informal network had everything this launch needs. Networks don't survive rotation." },
    { dmg: 5,  text: "I'll post in the all-brands Slack and create a LinkedIn group. Forty-three members. No posts. Cover image is a Baja Blast.", trap: true },
  ],
  'Incentive Compat.': [
    { dmg: 40, text: "The strategy proposer was rotated eight months ago. The implementer has been here eleven days. Proposer has no stake in execution. Implementer has no stake in the original brief. Incentive compatibility is zero." },
    { dmg: 30, text: "Directors propose, brand leads implement, nobody owns the full chain. You reward idea submission and hope for implemented innovation. Kerr called this in 1975." },
    { dmg: 20, text: "This brief has been through three brand leads. Each adapted it and rotated before finding out if their changes worked. The learning loop is broken across time." },
    { dmg: 5,  text: "Schedule a thirty-minute handoff. They share the link to FINAL v3 USE THIS ONE. Incoming lead nods. We call it a knowledge transfer.", trap: true },
  ],
};
